...
public class TestsApplication {
    ...
    public void ajoutPersonneOKBD() throws Exception{
       ...
       personne.idPersonne = 1L;
        ...
        bd.monDao().insertPersonne(personne); //this is the id


        assertNotNull(bd.monDao().insertPersonne(personne));
        assertTrue(bd.monDao().insertPersonne(personne) >= 0);
